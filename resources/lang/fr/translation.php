...
return [
    ...
    "404-error-cover" => "404 Couverture d'erreur",
    "404-error-basic" => "404 Erreur de base",
    "404-error-alt" => "404 Erreur Alt",
    ...
    "vector" => "Vecteur",
    "leaflet" => "Brochure",
    "google-map" => "Google Plans",
    "vector-map" => "Cartes vectorielles",
